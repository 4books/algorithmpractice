package programers.level2.p42586;
/*
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[] answer2 = s.solution(progresses2, speeds2);
        for (int i = 0; i < answer2.length; i++) {
            System.out.print(answer2[i] + " ");
        }
        System.out.println();

        int[] progresses3 = {99, 99, 99, 99, 99, 99};
        int[] speeds3 = {1, 1, 1, 1, 1, 1};

        int[] answer3 = s.solution(progresses3, speeds3);
