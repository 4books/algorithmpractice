package programers.level1.p77484;
/*
...
public class Main {
    ...
    static int[] solution(int[] lottos, int[] win_nums) {
        ...
        answer[0] = getRank(corretCount + zeroCount);
        answer[1] = getRank(corretCount);
    ...
    public static void main(String[] args) {
        ...
        int[] solution2 = solution(lottos2, win_nums2);
        for (int i : solution2) {
            System.out.print(i);
        }
        System.out.println();
        ...
        int[] solution3 = solution(lottos3, win_nums3);
        for (int i : solution3) {
            System.out.print(i);
        }
        System.out.println();
